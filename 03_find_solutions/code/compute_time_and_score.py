...
# Example:
# python compute_time_and_score.py C:\Users\jasonjia\Dropbox\02_jason_personal\cmsc_courses\cmsc_27200\project\03_find_solutions\all_inputs\[noname]_small1.in C:\Users\jasonjia\Dropbox\02_jason_personal\cmsc_courses\cmsc_27200\project\03_find_solutions\all_outputs\output_best_solutions_manual\[noname]_small1.out

# python compute_time_and_score.py C:\Users\jasonjia\Dropbox\02_jason_personal\cmsc_courses\cmsc_27200\project\03_find_solutions\all_inputs\[noname]_large3.in C:\Users\jasonjia\Dropbox\02_jason_personal\cmsc_courses\cmsc_27200\project\03_find_solutions\all_outputs\output_best_solutions_manual\[noname]_large3.out
...
#Previous code:
# Import directory
#inputfolder = Path(r"C:\Users\jasonjia\Dropbox\02_jason_personal\cmsc_courses\cmsc_27200\project\all_inputs")
#arraynumber = 6
#6

# Import input only if index = specified array number
#for index, item in enumerate(inputfolder.iterdir()):
#    if index == arraynumber:
#        print("Index:", index)
#        print("Input File Processed:", item)
#        item_arraynumber = item
#        with open(item) as f:
#            N = int(f.readline())
